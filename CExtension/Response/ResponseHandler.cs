...
namespace CExtension.Response
{
    public class ResponseHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        protected override async Task HandleChallengeAsync(AuthenticationProperties properties)
        {
            ...
            await Response.WriteAsync(JsonConvert.SerializeObject(new Response<string>(StatusCodes.Status401Unauthorized)));
        }
        ...
        protected override async Task HandleForbiddenAsync(AuthenticationProperties properties)
        {
            ...
            await Response.WriteAsync(JsonConvert.SerializeObject(new Response<string>(StatusCodes.Status403Forbidden)));
        }
    }
}
