...
namespace CExtension.Authorization
{
    /// <summary>
    /// 授权处理程序
    /// </summary>
    public class AuthorizationHandler : AuthorizationHandler<PermissionRequirement>
    {
        ...
        public AuthorizationHandler(IHttpContextAccessor accessor, IAuthenticationSchemeProvider schemes, IPermissionService roleModulePermissionServices) 
        {
            _accessor = accessor;
            _schemes = schemes;
